...
type SignerInfo struct {
	version                   int                              "版本"
	issuerAndSerialNumber     engineX509.IssuerAndSerialNumber "颁发者信息"
	digestAlgorithm           pkix.AlgorithmIdentifier         "摘要算法"
	attributes                []engineX509.Attribute           "optional,tag:0, 签名者属性"
	digestEncryptionAlgorithm pkix.AlgorithmIdentifier         "签名算法"
	encryptDigest             asn1.RawValue                    "签名值,SM2时是 SM2Signature"
	unauthenticatedAttributes []engineX509.Attribute           "optional,tag:1"
}
